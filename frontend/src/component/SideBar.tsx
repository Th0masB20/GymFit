...
const SideBar = (): React.ReactElement => {
  ...
  return (
    <nav className="h-full w-20 tablet:w-16 mobile:w-14 bg-main fixed top-0 flex flex-col justify-between items-center z-10">
      ...
      <div className="flex flex-col items-center justify-between h-48 w-full">
        ...
        />
        <button
          className="bg-SettingsImage bg-cover w-11 h-11 mobile:w-10 mobile:h-10 hover:scale-110 transition-all"
          onClick={patchTest}
        />
      </div>
    </nav>
